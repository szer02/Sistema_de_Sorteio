...
// Configurar a fábrica de conexão e repositórios
...
builder.Services.AddScoped<IParticipanteRepositorio, ParticipanteRepositorio>();
builder.Services.AddScoped<ISorteioRepositorio, SorteioRepositorio>();
